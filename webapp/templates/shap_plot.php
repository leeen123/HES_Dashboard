    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex flex-row" id="navbarNav">
          <li class="nav-item">
            <a class="nav-link active" href="/shap_plot.html" id="shap-link" style="margin-right: 10px;">SHAP Plot Analysis</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/compare.html" id="compare-link">Comparing Analysis</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <div id="shap-plot-section" class="container-cus">
    <div class="row">
      ...
      <div class="col-md-9 pr-0 my-4">
        ...
        <div class="d-flex">
          <div class="col-12 col-md-6 blockarea mt-3 mb-md-4" style="height: 280px;">
          ...
          <div class="col-12 col-md-6 blockarea ml-3 mt-3 mb-md-4" style="height: 280px ">
