...
<body>
  ...
  <nav class="blockarea navbar1" style="padding: 10px 20px;">
    ...
    <ul class="navbar-nav d-flex flex-row" id="navbarNav">
      <li class="nav-item">
        <a class="nav-link active" href="shap_plot.php" id="shap-link">SHAP Plot Analysis</a>
      </li>
      <li class="nav-item">
  ...
  <div id="shap-plot-section" class="container-cus">
    <div class="row">
      ...
      <div class="col-md-9 pr-0 my-4">
        <!-- The 3th areas -->
        <div class="d-flex">
          <div class="col-6 blockarea" style="height: 350px;">
            <h5 class="block-title">SHAP Dependence Plot</h5>
            <div class="d-flex justify-content-start py-4">
              <img id="shap-plot" src="../static/shap_plot.png" alt="SHAP Dependence Plot" class="img-fluid" style="width: 80%;">
            </div>
          </div>
          <div class="ml-3" style="flex: 0 0 50%">
              <!-- Here, at least 3 block area -->
              <div class="blockarea p-1 cardfont">
                <div>
                  <div class="card-body d-flex flex-row">
                      <span class="col-2 icon me-3 text-white mr-3">
                        <svg height="54px" width="54px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <div class="d-flex">
          <!-- The 4th areas -->
          <div class="col-6 blockarea mt-3" style="height: 280px">
          ...
          <div class="col-6 blockarea mt-3 ml-3" style="height: 280px">
        ...
        function updatePlot() {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              console.log("response receievd: ", typeof(response))
